...
public class FuncionariosView extends JPanel {
    ...
    private JPanel crearListado() {
        ...
        tabla.getSelectionModel().addListSelectionListener(e -> {
            if (!e.getValueIsAdjusting() && tabla.getSelectedRow() >= 0) {
                campoId.setText(String.valueOf(tabla.getValueAt(tabla.getSelectedRow(), 0)));
                campoNombre.setText(String.valueOf(tabla.getValueAt(tabla.getSelectedRow(), 1)));
                campoTelefono.setText(String.valueOf(tabla.getValueAt(tabla.getSelectedRow(), 2)));
            }
        });
    ...
    private void cargarTabla() {
        ...
        for (User funcionario : controller.buscar(filtroId.getText(), filtroNombre.getText())) {
            modelo.addRow(new Object[]{funcionario.getVarId(), funcionario.getVarNombre(),
    ...
    private void mostrarError(String mensaje) {
        JOptionPane.showMessageDialog(this, mensaje, "Funcionarios", JOptionPane.ERROR_MESSAGE);
    }
}
